...
## 🚀 Skills en technieken
- PHP basics: variabelen, loops, arrays, functies.  
- Input en output via CLI en HTML forms.  
- Database verbindingen met PDO en MySQL.  
- CRUD operaties in PHP.  
- Basis van Git voor versiebeheer.
